...
import 'package:flutter_kakao2/components/bottom_icon_button.dart';
import 'package:flutter_kakao2/components/round_icon_button.dart';
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image:
                    DecorationImage(image: NetworkImage(user.backgroundImage), fit: BoxFit.cover),
              ),
            ),
            SizedBox(height: 8),
            Text(
